...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    designation: Schema.Attribute.Enumeration<
      ['Founder', 'Writer', 'Editor', 'Contributor', 'Guest', 'Other']
    >;
    ...
    social_links: Schema.Attribute.Component<'element.social-link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    social: Schema.Attribute.Component<'element.link', true>;
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'title'>;
    timeline: Schema.Attribute.Component<'portfolio.timeline', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
